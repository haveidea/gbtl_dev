...
#set src [list $RTL_PATH/segment_memory_reg.sv]
...
create_clock -name clk -period $period -waveform {0 $half_period} [get_port clk]
...
set_output_delay -min -clock $clk_name 0.025 [all_outputs]
set_input_delay -max -clock $clk_name [expr $period/2] [get_ports $real_inputs]
set_input_delay -min -clock $clk_name 0.025 [get_ports $real_inputs]
